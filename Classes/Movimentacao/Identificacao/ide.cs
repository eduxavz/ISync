using ISync.Classes.Movimentacao.Movimentacao.Cobranca;
using ISync.Classes.Movimentacao.Movimentacao.Destinatario;
using ISync.Classes.Movimentacao.Movimentacao.Detalhe;
using ISync.Classes.Movimentacao.Movimentacao.Emitente;
using ISync.Classes.Movimentacao.Movimentacao.Intermediador;
using ISync.Classes.Movimentacao.Movimentacao.Pagamento;
using ISync.Classes.Movimentacao.Movimentacao.Total;
using ISync.Classes.Movimentacao.Movimentacao.Transporte;
using ISync.Classes.Movimentacao.Movimentacao.RespTecnico;
using System;
